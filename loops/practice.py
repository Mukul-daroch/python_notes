...
# Step 1: Collect all languages
#    for j in range(len(data[i].get("languages"))):
#        print(data[j].get("languages"))

#trup={}
#for i in range(len(data)-1):
#    for j in range(len(data[i].get("languages"))):
#        for k in j:
#            resultlist = trup.add(k)
#            print(resultlist)
...
l= 0
while z >= 0:
    lenght = len(data[z].get("languages"))
    l +=  lenght
    z -= 1
...
for i in range(len(data)):
    y = len(data[i].get("languages"))
    z += y

print(z)

total_languages = sum(len(country["languages"]) for country in data)
